...
magnifyp = LDPM.geometry_parameters[8] #control the miminum particle distance which equals manifyp*(radius of the first particle + radius of the second particle)
