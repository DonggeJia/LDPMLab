...
dimen1 = LDPM_w_steel.geometry_parameters[1] #mm
dimen2 = LDPM_w_steel.geometry_parameters[2] #mm
dimen3 = LDPM_w_steel.geometry_parameters[3] #mm
V = dimen1*dimen2*dimen3 - diameter_S^2/4*pi*dimen1*length(traverse_distribution)
c = LDPM_w_steel.geometry_parameters[4] #kg/mm3 cement content 
w_over_c = LDPM_w_steel.geometry_parameters[5] # water-to-cement ratio
#a_over_c = 10.7 # aggregate-to-cement ratio
da = LDPM_w_steel.geometry_parameters[6] #mm maximum aggregate size
d0 = LDPM_w_steel.geometry_parameters[7] #mm mminimum aggregate size
#q = 2.5 #material parameter
nF = LDPM_w_steel.geometry_parameters[8]
q = 3-nF
Rhoc = LDPM_w_steel.geometry_parameters[9] #kg/mm3
Rhow = LDPM_w_steel.geometry_parameters[10] #kg/mm3
vair = LDPM_w_steel.geometry_parameters[11] #typically 3%-4%
w = w_over_c*c
