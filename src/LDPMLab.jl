...
45000. # E_m -> Initial Elastic Modulus for the Matrix [MPa]
45000. # E_a -> Initial Elastic Modulus for the Aggregates [MPa]
3. # sigma_t -> Tension Limit [MPa]
-50. # sigma_c -> Compression Limit [MPa]
10. # sigma_s -> Shear Limit [MPa]
...
2. # n_t -> Exponent that Controls Transition of Softening Parameter [-]
0.8 # n_c -> Exponent that Controls Transition of Hardening Parameter [-]
2.5e-6 # rho -> Material's Mass Density [ton/mm^3]
1. # kc1 -> Volumetric Compression Parameter [-]
5. # kc2 -> Volumetric Compression Parameter [-]
11250. # K_c -> Parameter that Governs the Post-Peak Behavior in Compression [-] 
0. # zeta -> damping coefficient
LDPM.mechanical_parameters = [45000., 45000., 3., -50., 10., 0.07, 0.35, 0.25, 2., 0.8, 2.5e-6, 1., 5., 11250.,0.]
...
#epsi_sh = 0.02
#Esh = 833.33 #Mpa
LDPM_w_steel.mechanical_parameters = [45000., 45000., 3., -50., 10., 0.07, 0.35, 0.25, 2., 0.8, 2.5e-6, 1., 5., 11250.,0., 1.96*10^5, 500, 650, 0.02, 833.33]
