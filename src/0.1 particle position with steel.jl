...
magnifyp = LDPM_bar_reforced.geometry_parameters[12] #control the miminum particle distance which equals manifyp*(radius of the first particle + radius of the second particle)
