...
c = LDPM.geometry_parameters[4] #kg/mm3 cement content 
w_over_c = LDPM.geometry_parameters[5] # water-to-cement ratio
#a_over_c = 10.7 # aggregate-to-cement ratio
da = LDPM.geometry_parameters[6] #mm maximum aggregate size
d0 = LDPM.geometry_parameters[7] #mm mminimum aggregate size
#q = 2.5 #material parameter
nF = LDPM.geometry_parameters[8]
q = 3-nF
