...
4. Set a boundary condition
    ...
    The boundary condictions are marked on each point with a format `local freedom degree_velocity`. Each point will have at most 6 marks for freedom degrees in x-direction movement, y-direction movement, z-direction movement, Rotation about the x-axis,
